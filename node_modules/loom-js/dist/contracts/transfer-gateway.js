...
var TransferGateway = /** @class */ (function (_super) {
     ...
     *          request.
     */
    TransferGateway.prototype.withdrawTRXAsync = function (amount, tokenContract, recipient) {
        var req = new transfer_gateway_pb_1.TransferGatewayWithdrawTokenRequest();
        req.setTokenKind(transfer_gateway_pb_1.TransferGatewayTokenKind.TRX);
        req.setTokenAmount(big_uint_1.marshalBigUIntPB(amount));
        req.setTokenContract(tokenContract.MarshalPB());
        if (recipient) {
            req.setRecipient(recipient.MarshalPB());
     ...
     *          request.
     */
    TransferGateway.prototype.withdrawTRC20Async = function (amount, tokenContract, recipient) {
        var req = new transfer_gateway_pb_1.TransferGatewayWithdrawTokenRequest();
        req.setTokenKind(transfer_gateway_pb_1.TransferGatewayTokenKind.TRC20);
        req.setTokenAmount(big_uint_1.marshalBigUIntPB(amount));
        req.setTokenContract(tokenContract.MarshalPB());
        if (recipient) {
            req.setRecipient(recipient.MarshalPB());
