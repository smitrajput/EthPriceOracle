...
var DPOS3 = /** @class */ (function (_super) {
    ...
    DPOS3.prototype.claimDelegatorRewardsAsync = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, resp;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = new dposv3_pb_1.ClaimDelegatorRewardsRequest();
                        resp = new dposv3_pb_1.ClaimDelegatorRewardsResponse();
                        return [4 /*yield*/, this.callAsync('ClaimRewardsFromAllValidators', req, resp)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, resp.getAmount() ? big_uint_1.unmarshalBigUIntPB(resp.getAmount()) : new bn_js_1.default(0)];
                }
            });
        });
    };
    DPOS3.prototype.checkDelegatorRewardsAsync = function (delegator) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var req, result;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req = new dposv3_pb_1.CheckDelegatorRewardsRequest();
                        req.setDelegator(delegator.MarshalPB());
                        return [4 /*yield*/, this.staticCallAsync('CheckRewardsFromAllValidators', req, new dposv3_pb_1.CheckDelegatorRewardsResponse())];
                    case 1:
                        result = _a.sent();
